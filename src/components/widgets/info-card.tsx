...
export const InfoCard = ({ icon: Icon, title, desc }: IProps) => {
	return (
		<Card className='group relative overflow-hidden bg-card/40 border-white/5 hover:border-white/20 transition-all duration-300 hover:-translate-y-1'>
			...
			<CardHeader className='space-y-4'>
				<div className='w-10 h-10 rounded-lg bg-secondary/20 flex items-center justify-center border border-white/5 text-foreground'>
			...
			<CardContent className='space-y-6'>
				...
				<div className='flex items-center text-[10px] font-bold uppercase text-white/50 group-hover:text-white transition-colors cursor-pointer'>
