...
export const AuthorBadge: FC<IProps> = ({ name, role }) => {
	return (
		<div className='flex items-center gap-3 px-4 py-2 rounded-xl bg-accent-foreground/5 border border-accent-foreground/10 backdrop-blur-sm hover:bg-accent-foreground/10 transition-colors group'>
