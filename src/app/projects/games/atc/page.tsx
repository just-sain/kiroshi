		...
		<div className='min-h-screen text-foreground overflow-x-hidden'>
			<div className='relative container mx-auto px-4 py-12 space-y-28'>
				...
				<section className='relative mt-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center'>
					{/* Изображение проекта */}
					<div className='lg:col-span-7 relative group border border-white/10 rounded-[2rem] overflow-hidden bg-card/30 backdrop-blur-md shadow-2xl'>
						<div className='aspect-video bg-muted/20 relative flex items-center justify-center'>
							<Image fill alt='ATC' className='object-fill' src='/projects/games/atc/atc.png' />
						</div>
					</div>
					...
					<div className='lg:col-span-5 space-y-8'>
						...
						<div className='flex flex-col sm:flex-row gap-4'>
							<Button
								...
								size='lg'
							>
								<Link download='atc-simulation.zip' href='/projects/games/atc/game.zip'>
									<Download className='w-6 h-6' /> СКАЧАТЬ ATC
								</Link>
							</Button>
							<Button
								disabled
								className='h-16 px-8 rounded-2xl border-white/10 bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors'
								size='lg'
								variant='outline'
							>
								ДОКУМЕНТАЦИЯ
				...
				<section className='relative space-y-16 py-12'>
					...
					<div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
						{/* Блок: Физика */}
						<div className='p-8 rounded-[2rem] bg-card/40 border border-white/10 backdrop-blur-md space-y-4'>
				...
				<section className='space-y-12'>
					...
					<GameGallery
						images={[
							'/projects/games/atc/1.png',
							'/projects/games/atc/2.png',
							'/projects/games/atc/3.png',
							'/projects/games/atc/4.png',
						]}
					/>
				</section>
